...
1. Тема письма (Subject) — кратко и официально, на английском, без русских слов. Например: "Report of Personal Data Leak on Telegram Channel" или "Report of Illegal Goods Distribution on Telegram Channel".
...
async function scanChannel(chatId, username, progressMsgId) {
    ...
    // ---- ОТПРАВЛЯЕМ ЗАКОНЫ (ТОЛЬКО ССЫЛКИ) ----
