...
//  ЧАСТЬ 1: Конфигурация, импорты, инициализация сервера и клиента
// ============================================================
...
// ============================================================
//  bot.js — анализ Telegram-каналов на утечки персональных данных
//  ЧАСТЬ 2: Логика анализа, работа с Gemini, генерация отчётов и жалоб
// ============================================================
...
async function buildComplaint(channelLink, violationLink, violation) {
    try {
        return await generateComplaintViaAI(channelLink, violationLink, violation);
    } catch (e) {
        console.error('generateComplaintViaAI error, использую запасной шаблон:', e.message);
        return buildComplaintFallback(channelLink, violationLink, violation.category_en);
    }
}
